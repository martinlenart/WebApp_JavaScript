...
const formatterSv = new Intl.NumberFormat('sv-sv', { style: 'currency', currency: 'Sek' });
const moneyStringSv = formatterSv.format(someNumber);

console.log(`${someNumber} with a Swedish currency formatted is ${moneyStringSv}`);